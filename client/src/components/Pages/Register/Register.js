                    ...
                    <div className="main-login main-center">
                        <form className="form-horizontal" method="post" action="#">
                            ...
                            {/* <div id="locationField">
                                <input id="autocomplete" placeholder="Begin Typing Your Address Here" onFocus={geolocate()} type="text"></input>
                            </div> */}
                            ...
                            <div className="form-group" id = "locationField" >
                                ...
                                <div className="cols-sm-10">
                                    <div className="input-group">
                                        ...
                                        <input id="autocomplete" onFocus={geolocate()} type="text" className="form-control" placeholder="Begin Typing Your Address" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td className="wideField" colspan="2"><input class="field" id="route" disabled="true"></input></td>
                                </tr>
                                <tr>
                                    <td className="label">City</td>
                                    <td className="wideField" colspan="3"><input className="field" id="locality" disabled="true"></input></td>
                                </tr>
                                <tr>
                                    <td className="label">State</td>
                                    <td className="slimField"><input className="field" id="administrative_area_level_1" disabled="true"></input></td>
                                ...
                                <tr>
                                    ...
                                    <td className="wideField" colspan="3"><input className="field" id="country" disabled="true"></input></td>
                                </tr>
                            </table>
                            ...
                            <div className="form-group">
                                ...
                                <div className="cols-sm-10">
                                    <div className="input-group">
                                        <span className="input-group-addon"><i className="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                                        <input type="text" className="form-control field" id="street_number" onChange={(e)=>this.handleChange(e)} value={this.state.address}name="address" id="confirm" placeholder="Enter Your Address" />
