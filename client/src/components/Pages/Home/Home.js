...
class Home extends Component {
    render() {
        return ( <
            ...
            style = {
                { height: '45px', marginLeft: '95px' } } > Search Properties < span className = "lnr lnr-arrow-right" > < /span></button >
            <
            /div> <
            /div> <
            /div> <
            ...
            <
            h4 > < span className = "lnr lnr-user" > < /span>Lower Vacation Costs</h
            4 >
            <
            p >
            Plan a budget friendly vacation by saving money on housing.Dying to
            try that new restaurant or sail on a cruise around your favorite island ?
            ...
            div className = "single-service" >
            <
            h4 > < span className = "lnr lnr-license" > < /span>Professional Service</h
            4 >
            <
            p >
            Feel safe swapping apartments knowing we take our user safety seriously.Read and write reviews of past visits.Know that every user is background checked before being allowed to use the application. <
            /p>								 <
            /div> <
            /div> <
            div className = "col-lg-4 col-md-6 pb-30" >
            ...
            div className = "single-service" >
            <
            h4 > < span className = "lnr lnr-phone" > < /span>Easy Access</h
            4 >
            <
            p >
            ...
            section className = "property-area section-gap relative"
            id = "property" >
            <
            div className = "overlay overlay-bg" > < /div> <
            div className = "container" >
