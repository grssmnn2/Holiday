      ...
      return (
        <Redirect
          to={{
            pathname: "/result",
            state: {
              stateName: this.state.stateName ? this.state.stateName : null
            }
          }}
        />
      );
                ...
                <div style={{ display: "block" }} className="row">
                  <div className="col-lg-4 col-md-6 pb-30">
                    <div className="single-service">
                      <h4>
                        <span className="lnr lnr-user" />Lower Vacation Costs
                      </h4>
                      <p>
                        Spend your money on what you truly care about it and
                        leave the housing concerns to us. Holiday provides you
                        with the opportunity to spend your vacation budget where
                        it matters most.
                      </p>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 pb-30">
                    <div className="single-service">
                      ...
                      <p>
                        We help connect travelers all over the world so they can
                        discover rustic, authentic, and unspoiled gems. Do what
                        the locals do, eat where they eat, and experience the
                        realness of the place you're visiting.
                      </p>
                    </div>
                  </div>
                  <div className="col-lg-4 col-md-6 pb-30">
                    <div className="single-service">
                      <h4>
                        <span className="lnr lnr-phone" />Easy Access
                      </h4>
                      <p>
                        Access our application from any device, on the go or at
                        home. Read and write reviews of past visits to prepare
                        other users for their stay. Save favorite homes so you
                        can easily revisit them when you're ready to swap.
                      </p>
                    </div>
                  </div>
                </div>
